var luxon = (function (exports) {
  ...
  var Interval = /*#__PURE__*/function () {
     ...
     * @param {Object} opts - options
     * @param {string} [opts.separator =  ' ΓÇô '] - a separator to place between the start and end representations
     * @return {string}
     */
    ;
    ...
    _proto.toFormat = function toFormat(dateFormat, _temp2) {
      var _ref3 = _temp2 === void 0 ? {} : _temp2,
          ...
          separator = _ref3$separator === void 0 ? " ΓÇô " : _ref3$separator;
  ...
  var Info = /*#__PURE__*/function () {
     ...
     * @example Info.months('numeric', { locale: 'ar' })[0] //=> '┘í'
     ...
     * @example Info.weekdays('short', { locale: 'ar' })[0] //=> '╪º┘ä╪º╪½┘å┘è┘å'
     * @return {Array}
     */
    ;
     ...
     * @example Info.meridiems({ locale: 'my' }) //=> [ 'ßÇößÇ╢ßÇößÇÇßÇ║', 'ßÇèßÇößÇ▒' ]
     * @return {Array}
     */
    ;
  ...
  var numberingSystems = {
    ...
    fullwide: "[\uFF10-\uFF19]",
    gujr: "[\u0AE6-\u0AEF]",
    hanidec: "[πÇç|Σ╕Ç|Σ║î|Σ╕ë|σ¢¢|Σ║ö|σà¡|Σ╕â|σà½|Σ╣¥]",
    khmr: "[\u17E0-\u17E9]",
    knda: "[\u0CE6-\u0CEF]",
    laoo: "[\u0ED0-\u0ED9]",
    limb: "[\u1946-\u194F]",
