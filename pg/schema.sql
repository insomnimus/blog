...
CREATE TABLE cache (
	...
	notes TIMESTAMP NOT NULL DEFAULT(CURRENT_TIMESTAMP),
	music TIMESTAMP NOT NULL DEFAULT(CURRENT_TIMESTAMP),
...
CREATE TABLE note_media (
	...
	note_id INTEGER NOT NULL REFERENCES note ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- Initialization --
INSERT INTO cache(_instance) VALUES('TRUE');
